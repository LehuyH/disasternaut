    ...
    <section class="letter" v-if="state.interaction.showLetter" @click="dismiss">
        <div>
            <section v-if="state.interaction.quotaSuccess">
                ...
                gratitude <b>you will receive upgrades to your armor</b>.
                <br><br>
                Your next quota has been assigned! We look forward to seeing your continued progress.
                <br><br><br>
                Thanks,
                <br>
                <i>
            ...
            <section v-else-if="state.persistent.failures === 1">
                ...
                <br><br>
                During the audit, we will monitor your planetary activity and make sure your resources are distributed
                appropriately. If this does not happen, we will have no choice but to revoke your planetary charter.
                <br><br>
                If your audit is deemed a success, we will send your planet a congratulatory packet. However, if you do
                not
                abide by our terms, you will not receive the congratulations.
                <br><br>
                We hope you understand the importance of meeting your quotas.
                <br><br><br>
                Thanks,
                <br>
                <i>
            ...
            <section v-else-if="state.persistent.failures === 2">
                ...
                Dear colonizer, {{state.persistent.name}}<br><br>

                Your audit was conducted and reviewed by our highly efficient auditing staff. However, the auditors had
                a
                ...
                <br><br>
                As a LAST RESORT, we will offer a final audit to insure your progress. If your planet fail this audit
                too,
                ...
                <br><br>
                <b>This will be the LAST audit you will receive. The Quota is due on Day
                    {{state.persistent.quotaDay}}</b>
                <br><br><br>
                Thanks,
                <br>
                <i>
